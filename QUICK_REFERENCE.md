...
|------|-------------|--------------|
| `WEEKLY_MISTAKES_REPORT.md` | Weekly report (default) | `weekly_mistakes_report.py` |
| `defi_du_jour_results.json` | Today's parsed results | `parse_results.py` |
| `mistakes_history.json` | All historical mistakes | `accumulate_mistakes.py` |
| `mistakes_log.md` | All mistakes (readable) | `accumulate_mistakes.py` |
| `mistakes_by_category.md` | Mistakes by category | `accumulate_mistakes.py` |
